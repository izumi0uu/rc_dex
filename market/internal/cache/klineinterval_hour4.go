...
type KlineIntervalHour4 struct {
	interval constants.KlineInterval
	duration time.Duration
}

func NewKlineIntervalHour4() *KlineIntervalHour4 {
	return &KlineIntervalHour4{
		interval: constants.KlineMin1,
		duration: time.Second * 3600 * 4,
	}
}

func (k *KlineIntervalHour4) GetOpenClose(chainId constants.ChainId, pairAddr string) (float64, float64) {
...
func (k *KlineIntervalHour4) GetUpDown(chainId constants.ChainId, pairAddr string) float64 {
