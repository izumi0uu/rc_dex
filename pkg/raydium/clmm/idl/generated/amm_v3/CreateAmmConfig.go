...
// CreateAmmConfig is the `createAmmConfig` instruction.
...
func (inst *CreateAmmConfig) SetTickSpacing(tickSpacing uint16) *CreateAmmConfig {
	inst.TickSpacing = &tickSpacing
	return inst
}

// SetTradeFeeRate sets the "tradeFeeRate" parameter.
func (inst *CreateAmmConfig) SetTradeFeeRate(tradeFeeRate uint32) *CreateAmmConfig {
	inst.TradeFeeRate = &tradeFeeRate
	return inst
}

// SetProtocolFeeRate sets the "protocolFeeRate" parameter.
func (inst *CreateAmmConfig) SetProtocolFeeRate(protocolFeeRate uint32) *CreateAmmConfig {
	inst.ProtocolFeeRate = &protocolFeeRate
	return inst
}

// SetFundFeeRate sets the "fundFeeRate" parameter.
func (inst *CreateAmmConfig) SetFundFeeRate(fundFeeRate uint32) *CreateAmmConfig {
