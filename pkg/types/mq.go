...
// // ValidateRaydiumPool checks if all required fields are set
// func ValidateRaydiumPool(pool *solmodel.RaydiumPool) error {
// 	if pool == nil {
// 		return errors.New("raydium pool is nil")
// 	}
...
// 		{pool.AmmId, "amm_id"},
// 		{pool.AmmAuthority, "amm_authority"},
// 		{pool.AmmOpenOrders, "amm_open_orders"},
// 		{pool.AmmTargetOrders, "amm_target_orders"},
// 		{pool.PoolCoinTokenAccount, "pool_coin_token_account"},
// 		{pool.PoolPcTokenAccount, "pool_pc_token_account"},
// 		{pool.SerumProgramId, "serum_program_id"},
// 		{pool.SerumMarket, "serum_market"},
// 		{pool.SerumBids, "serum_bids"},
// 		{pool.SerumAsks, "serum_asks"},
// 		{pool.SerumEventQueue, "serum_event_queue"},
// 		{pool.SerumCoinVaultAccount, "serum_coin_vault_account"},
// 		{pool.SerumPcVaultAccount, "serum_pc_vault_account"},
// 		{pool.SerumVaultSigner, "serum_vault_signer"},
// 		// {pool.TxHash, "tx_hash"},
// 	}
...
// 		case string:
// 			if v == "" {
// 				return fmt.Errorf("field %s is empty", check.name)
// 			}
// 		case int64:
// 			if v == 0 {
// 				return fmt.Errorf("field %s is zero", check.name)
// 			}
// 		}
// 	}
