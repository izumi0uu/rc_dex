...
// FreezeAccount is the `freezeAccount` instruction.
...
func (inst *FreezeAccount) SetOwnerAccount(owner ag_solanago.PublicKey) *FreezeAccount {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(owner).SIGNER()
	return inst
}

// GetOwnerAccount gets the "owner" account.
func (inst *FreezeAccount) GetOwnerAccount() *ag_solanago.AccountMeta {
...
func (inst FreezeAccount) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: Instruction_FreezeAccount,
	}}
}
...
func NewFreezeAccountInstruction(
	...
	owner ag_solanago.PublicKey) *FreezeAccount {
