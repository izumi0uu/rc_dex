...
// InitializeMint2 is the `initializeMint2` instruction.
...
func (inst *InitializeMint2) SetMintAuthority(mintAuthority ag_solanago.PublicKey) *InitializeMint2 {
	inst.MintAuthority = &mintAuthority
	return inst
}

// SetFreezeAuthority sets the "freezeAuthority" parameter.
func (inst *InitializeMint2) SetFreezeAuthority(freezeAuthority ag_solanago.PublicKey) *InitializeMint2 {
...
func (inst InitializeMint2) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: Instruction_InitializeMint2,
	}}
}
