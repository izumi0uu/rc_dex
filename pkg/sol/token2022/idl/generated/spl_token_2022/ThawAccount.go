...
// ThawAccount is the `thawAccount` instruction.
...
func (inst *ThawAccount) SetOwnerAccount(owner ag_solanago.PublicKey) *ThawAccount {
	inst.AccountMetaSlice[2] = ag_solanago.Meta(owner).SIGNER()
	return inst
}

// GetOwnerAccount gets the "owner" account.
func (inst *ThawAccount) GetOwnerAccount() *ag_solanago.AccountMeta {
...
func NewThawAccountInstruction(
	...
	owner ag_solanago.PublicKey) *ThawAccount {
