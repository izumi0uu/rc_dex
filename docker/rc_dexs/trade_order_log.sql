...
(
    ...
    is_auto_slippage tinyint(1)      default 0                    not null,
    ...
    constraint order_id_index
        unique (order_id, status)
)
    charset = utf8mb4;

create index trade_order_log_create_time_status_chain_id_index
    on trade_order_log (created_at, status, chain_id);
